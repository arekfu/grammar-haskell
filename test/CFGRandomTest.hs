...
prop_terminalsAreInvariant :: ACharCFG -> Positive (Large Seed) -> Property
prop_terminalsAreInvariant (ACharCFG g) (Positive (Large seed)) =
...
prop_deriveWord0IsId :: ACharCFG -> Positive (Large Seed) -> Property
prop_deriveWord0IsId (ACharCFG g) (Positive (Large seed)) =
...
prop_deriveGrammar0IsId :: ACharCFG -> Positive (Large Seed) -> Property
prop_deriveGrammar0IsId (ACharCFG g) (Positive (Large seed)) =
    let syms = toList $ getSymbols g
